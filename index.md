...
- 大学在学中に行っていた研究のために、Pythonでデータ分析をはじめる。
  - その後、[Julia](https://julialang.org/)の書きやすさや計算速度に惹かれ、Juliaで分析をするようになる。
- 博士課程を単位取得退学後、日本国内の外資メーカーで製品開発と研究をはじめる。

- SNS
  - GitHub: [SosUts](https://github.com/SosUts)
  - Twitter: Sosuke([@sosuts](https://twitter.com/sos_uts))
...
- Completed Ph.D program without a Ph.D. degree, Department of Biological Sciences, Osaka University, Japan(2021)
  - I am aiming to Ph.D. in 2022 - 2023.
